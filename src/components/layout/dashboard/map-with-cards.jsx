...
export default function MapWithCards({
    ...
    return (
      <div className="h-full flex flex-col relative">
        <div className="flex-1 ">
          <MapViewMapbox vehicleCards={vehicleCards} />
        </div>
        <Button
        ...
        <Sheet
          ...
          onOpenChange={(open) => {
            ...
            // Nudge map after the sheet animates
        ...
        >
          <SheetContent side="bottom" className="h-[80vh] p-0">
            ...
            <div className="mt-2 overflow-auto h-[calc(80vh-72px)]">
              <CardsViewSidebar vehicleCards={vehicleCards} />
            </div>
          </SheetContent>
        </Sheet>
      </div>
  ...
  return (
    <div className="h-full flex ">
      ...
      <aside
        className={`transition-all duration-300 ease-in-out border-l bg-background z-4 ${
          isMinimized ? 'w-12' : 'w-96'
        }`}
        data-testid="map-cards-panel"
        onTransitionEnd={(e) => {
          // Only react to width changes of the aside itself
        ...
        {isMinimized ? (
          <div className="h-full flex flex-col  py-4 pt-0 gap-4">
            ...
            {/* <div className="flex flex-col items-center gap-2">
              <Badge className=" whitespace-nowrap text-sm font-medium text-white">
                {vehicleCards.length}
              </Badge>
            </div> */}
          </div>
